export const personalInfo = {
  ...
  cvPath: "/assets/cv/MyCV.pdf?v=20260713",
...
export const aboutContent = {
  paragraphs: [
    "I am a Computer Science graduate with hands-on experience developing web applications, educational technology platforms, and management systems. I work across the modern JavaScript/TypeScript ecosystem with React, Next.js, and Node.js, plus performance testing with JMeter and security assessment with Snyk. I am comfortable owning features end to end from architecture through delivery in both team and independent settings.",
    "My recent work includes the Ghana Police Service Staff Management System, FHM-Meet, Digi-Receipt, Lambda LMS, Lambda Annotate, and SkillSwap — spanning public-service admin tools, WebRTC, donation workflows, and EdTech. I care about secure, reliable delivery for education and community-impact products.",
